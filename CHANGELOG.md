...
- Keep direct bindings with unavailable direction evidence explicitly unclassified rather than inferring flow.
- Keep unsupported pin expressions in their separate evidence channel and do not assign them driver/load roles.
