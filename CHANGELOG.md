...
- Harden Desktop rendering of that correlation: require complete recognized evidence,
  preserve explicit `match_basis` provenance, and fail closed on malformed, empty, or
