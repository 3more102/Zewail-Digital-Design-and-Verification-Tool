...
- Read-only desktop Debug Studio foundation using Python Tk/ttk, backed by persisted verification evidence; detailed panes expose bounded assertion events, formal property results, and UVM report messages
