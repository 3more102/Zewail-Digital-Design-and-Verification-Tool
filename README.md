...
- [x] Questa documented multibit expression FEC term/index normalization and coverage-hole reporting
- [ ] Questa toggle/FSM item-level normalization
