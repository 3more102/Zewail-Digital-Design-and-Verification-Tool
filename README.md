...
- Read-only desktop Debug Studio using Python Tk/ttk, backed by persisted verification evidence, deterministic source/hierarchy navigation, persisted elaborated hierarchy, recorded waveform browsing, and bounded in-memory VCD probing
