...
- [x] Desktop Debug Studio read-only foundation (summary, runs, failures, coverage, evidence, sources/hierarchy, waveform navigation, and detailed assertion/formal/UVM views)
- [x] Read-only RTL preview with source/hierarchy-to-RTL cross-navigation
