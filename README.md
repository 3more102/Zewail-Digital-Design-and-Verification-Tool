...
- Formal adapter API with normalized check/property/result contracts, persisted evidence history, finite-depth SymbiYosys BMC execution, direct cover-property reachability, native VCD counterexample/witness normalization, and normalized formal-trace cross-probing to RTL/source evidence
...
zddv --project my_project formal-trace-crossprobe trace.json --signal top.dut.state --signal req
...
- [x] Formal trace signal cross-probing to RTL/source hierarchy and connectivity evidence
