...
- Formal adapter API with normalized check/property/result contracts, persisted evidence history, finite-depth SymbiYosys BMC execution, direct cover-property reachability, native VCD counterexample/witness normalization, and automatic snapshot-scoped normalization of persisted VCD traces
...
- [x] Counterexample/witness normalization from normalized JSON and native VCD traces, including automatic snapshot-scoped persistence normalization
