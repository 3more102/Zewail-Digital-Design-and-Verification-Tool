...
- Desktop Debug Studio using Python Tk/ttk with read-only evidence/source/hierarchy/waveform navigation, bounded assertion/formal/UVM detail panes, and SHA-confirmed structured lint/build/run actions
...
- [x] Desktop Debug Studio evidence/source/hierarchy/waveform/UVM views with bounded probing and detailed normalized evidence
- [x] Review-gated desktop lint/build/run actions with canonical request SHA-256 confirmation and no arbitrary shell command
