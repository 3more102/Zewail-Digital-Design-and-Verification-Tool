...
- Simulator-independent UVM sequence-item handshake normalization with run correlation, SQLite snapshot/event persistence, and history filtering\n- Explicit UVM sequencer REQUEST/GRANT arbitration evidence for all six UVM modes, deterministic FIFO/strict checks, optional project-defined max-bypass policy, run correlation, SQLite decision/violation persistence, and history filtering
