...
- Desktop Debug Studio using Python Tk/ttk with read-only evidence/source/waveform navigation, SHA-confirmed lint/build/run actions, and a separate SHA-gated generated-artifact stage/apply review workflow
