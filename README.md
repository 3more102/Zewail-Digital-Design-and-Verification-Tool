...
- Read-only desktop Debug Studio using Python Tk/ttk, backed by persisted verification evidence, deterministic source/hierarchy navigation, persisted elaborated hierarchy, bounded in-memory VCD probing, and bounded assertion/formal/UVM detail panes
...
- [x] Read-only source/hierarchy navigation, persisted elaborated hierarchy, waveform probing, and detailed assertion/formal/UVM panes
