...
- Explicit `ZDDV_UVM_SEQUENCE` / `ZDDV_UVM_ITEM` log-marker ingestion, aggregate `uvm-marker-analyze`, and automatic evidence-gated post-run normalization for Questa, VCS, and Xcelium
