...
- [x] Xcelium documented IMC Overall score normalization into percentage-native coverage history
- [ ] Xcelium per-metric and item-level coverage normalization
- [ ] Formal adapter API
