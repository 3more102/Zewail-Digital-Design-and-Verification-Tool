...
- Formal adapter API with normalized check/property/result contracts, persisted evidence history, finite-depth SymbiYosys BMC execution, direct cover-property reachability, native VCD counterexample/witness normalization, and automatic per-snapshot VCD trace normalization during result persistence
...
- [x] Automatic backend-reported VCD counterexample/witness normalization during result persistence
