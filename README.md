...
- Simulator-independent UVM sequence-item handshake JSON model with GRANT/REQUEST/ITEM_DONE/RESPONSE validation, partial-trace handling, run correlation, observed grant-order evidence, SQLite event/violation persistence, history, and violation-query CLI
