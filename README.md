...
- [x] Desktop Debug Studio read-only foundation (summary, runs, failure groups, assertions, coverage, formal, UVM, sources, and hierarchy)
- [ ] Waveform/probe panes and explicitly review-gated project actions
