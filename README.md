...
- Simulator-independent UVM sequence-item handshake normalization with run correlation, SQLite snapshot/event persistence, history filtering, observed GRANT-order reconstruction, and portable `ZDDV_ITEM_TRACE_V1` log instrumentation ingestion
...
- [x] Portable sequence-item log instrumentation helper plus Questa/VCS run auto-ingestion
