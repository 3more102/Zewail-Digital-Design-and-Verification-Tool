...
- Formal adapter API with normalized check/property/result contracts, persisted evidence history, finite-depth SymbiYosys BMC, and bounded cover-property reachability with machine-readable property status
