...
- Desktop Debug Studio using Python Tk/ttk with read-only evidence/source/waveform browsing plus a review-gated SHA-confirmed action for applying already-staged generated verification code
