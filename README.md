...
- Evidence-gated direct elaborated instance-boundary driver/load classification from normalized CELL-pin-to-VARREF bindings and normalized port directions; unknown directions remain unclassified
