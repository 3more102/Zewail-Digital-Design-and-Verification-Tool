...
> Status: **v0.6 UVM & Simulator Adapters — simulator-independent UVM result ingestion plus a Questa compile/run foundation, with the v0.5 protocol verification stack retained**
...
- Reproducible Questa seeds, runtime plusargs, timeouts, optional VCD capture, assertion ingestion, and UVM-log normalization
...
Use the Questa foundation on a project whose RTL/testbench is supported by Questa:
