...
- Waveform-to-RTL source cross-probing with hierarchy-aware signal resolution, normalized elaborated module-port/direct pin-binding evidence when available, and explicit opt-in FST indexing through `fst2vcd`
