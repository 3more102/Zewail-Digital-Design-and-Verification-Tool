...
- Read-only desktop Debug Studio with persisted verification views, source navigation, and source/elaborated hierarchy browsing
...
- [x] Desktop Debug Studio read-only foundation with source and hierarchy navigation
- [ ] Waveform/probe navigation and review-gated project actions in the desktop UI
