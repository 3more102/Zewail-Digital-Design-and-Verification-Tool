...
- Read-only desktop Debug Studio using Python Tk/ttk, backed by persisted verification evidence plus source, hierarchy, waveform-catalog, and bounded VCD-probe navigation
