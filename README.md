...
- Read-only desktop Debug Studio using Python Tk/ttk, backed by persisted verification evidence, deterministic source/hierarchy navigation, persisted elaborated hierarchy, and in-memory recorded-VCD browsing/probing
