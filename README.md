...
- Explicit simulator-independent `ZDDV_ITEM` UVM report-log adapter for GRANT/REQUEST/ITEM_DONE/RESPONSE evidence, with run correlation and SQLite item history
