...
- [x] Source/hierarchy RTL preview and cross-navigation, including persisted elaborated-hierarchy source links
- [ ] Interactive waveform/UVM panes and review-gated project actions
