...
> Status: **v0.4 Debug Studio foundation — in progress**
...
- Static SystemVerilog source/design-unit index
- Top-down instance hierarchy JSON for Debug Studio consumers
