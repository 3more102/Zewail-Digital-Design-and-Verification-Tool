...
statement/branch rows plus scalar condition/expression FEC rows from
...
Multibit condition/expression layouts and toggle/FSM item normalization remain
pending. Questa's weighted total coverage remains a separate simulator-reported value.
