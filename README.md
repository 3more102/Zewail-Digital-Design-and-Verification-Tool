...
- Desktop Debug Studio using Python Tk/ttk with read-only evidence/source/hierarchy/waveform views, SHA-reviewed lint/build/run actions, and SHA-confirmed generated-artifact review/apply
