...
- Formal adapter API with normalized check/property/result contracts, persisted evidence history, finite-depth SymbiYosys BMC execution, and direct cover-property reachability
