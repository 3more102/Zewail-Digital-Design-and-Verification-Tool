...
- Desktop Debug Studio using Python Tk/ttk, with read-only persisted evidence/source/hierarchy/waveform views plus review-gated generated-artifact staging/apply using exact SHA-256 confirmation
