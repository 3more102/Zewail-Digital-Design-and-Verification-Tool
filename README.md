...
- Portable UVM item log-marker extraction from explicit `ZDDV_UVM_ITEM` JSON evidence, with source-line provenance and reuse of the existing item analyzer/history
