...
- Desktop Debug Studio using Python Tk/ttk with read-only evidence/source/hierarchy/waveform views, SHA-confirmed lint/build/run actions, and a separate generated-artifact review/apply pane
...
- [x] Review-gated generated-artifact stage/preview/apply with exact content SHA-256 and execution-disabled output
