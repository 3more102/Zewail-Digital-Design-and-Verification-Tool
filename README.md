...
and branch rows, scalar condition/expression FEC rows, and FSM state/transition
rows into `zddv coverage-holes`. Multibit condition/expression and toggle item
normalization remain pending. Questa's weighted total coverage remains a
