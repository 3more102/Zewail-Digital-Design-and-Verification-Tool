...
- [x] Desktop Debug Studio read-only views for runs, failures, coverage, evidence, source/hierarchy, and in-memory VCD waveform navigation/probing
- [ ] Detailed assertion/UVM/formal drill-down panes and review-gated project actions
