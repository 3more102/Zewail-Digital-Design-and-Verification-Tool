...
- Desktop Debug Studio using Python Tk/ttk with read-only persisted evidence, RTL/source/hierarchy and waveform navigation, bounded assertion/formal/UVM details, plus SHA-confirmed review-gated generated-artifact stage/apply actions
