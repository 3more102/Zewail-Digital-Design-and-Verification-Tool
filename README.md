...
- Evidence-gated validation of source port edges against normalized Verilator module-port direction and direct CELL pin-to-VARREF bindings without relabeling source roles
