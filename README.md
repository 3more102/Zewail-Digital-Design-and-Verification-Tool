...
- Desktop Debug Studio using Python Tk/ttk with read-only persisted evidence, deterministic source/hierarchy and waveform navigation, plus SHA-confirmed review-gated generated-artifact stage/apply actions plus bounded assertion, formal-property, and UVM-message detail panes
