...
- [x] Interactive source + hierarchy navigation with read-only RTL preview/cross-navigation and persisted elaborated-hierarchy evidence
- [ ] Waveform/UVM panes and review-gated project actions
