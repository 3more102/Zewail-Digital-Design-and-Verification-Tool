...
def test_historical_run_snapshot_binds_runtime_inputs_and_replay_contract(tmp_path: Path):
...
def test_reviewed_rerun_rejects_unknown_or_incompatible_historical_run(tmp_path: Path):
    project = initialize_project(tmp_path / "demo")

    with pytest.raises(ValueError, match="Run not found"):
        historical_run_snapshot(project, "missing")
