    ...
    *,
    ...
    def id_width_property(
        ...
        if not (request_present and response_present):
            # A VCD header describes what was dumped, not every physical port
            # on the interface. Missing or partial ID dumps therefore remain
            # unknown rather than being interpreted as a zero-width interface.
            return None
