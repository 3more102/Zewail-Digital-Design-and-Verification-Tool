...
CREATE INDEX IF NOT EXISTS idx_uvm_item_handshake_events_type
    ON uvm_item_handshake_events(event_type);
    ...
    with _connect(project) as db:
        ...
        db.executemany(
            ...
            INSERT INTO uvm_item_handshake_events (
                snapshot_id, event_index, item_id, event_type, sequence_id,
...
def list_uvm_item_handshake_events(
    ...
    *,
    ...
    query = """
        SELECT snapshot_id, event_index, item_id, event_type, sequence_id,
               sequence_name, sequencer, item_name, transaction_id,
               time_text, metadata_json
