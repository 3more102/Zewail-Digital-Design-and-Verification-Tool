...
from zddv.desktop_actions_ui import attach_desktop_actions_tab
...
def launch_desktop_gui(
    ...
    *,
    ...
    ttk.Label(
        footer,
        text=(
            "Browsing and Refresh are display-only. The Actions tab can execute only "
            "structured lint/build/run requests after exact SHA-256 review confirmation."
        ),
    ).pack(side="left")
