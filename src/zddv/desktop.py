    ...
    *,
    ...
    ttk.Label(
        ...
        text=(
            ...
            "invoke AI, write waveform reports, or apply generated artifacts."
        ),
    ).pack(side="left")
    ...
    def refresh() -> None:
        ...
        try:
            ...
            waveform_summary = waveform_current["summary"]
            waveform_info_var.set(
                f"{waveform_current['run_id']} · "
                f"{waveform_current['format'].upper()} · "
                f"{waveform_summary['signals']} signal(s) · "
                f"{waveform_summary['scopes']} scope(s) · "
