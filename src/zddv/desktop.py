...
def launch_desktop_gui(
    ...
    *,
    ...
    attach_desktop_actions_tab(notebook, project, limit=limit)
    ...
    ttk.Label(
        footer,
        text=(
            "Refresh/navigation are display-only. Project actions require explicit "
            "review plus confirmation before verification execution; AI and generated "
            "artifact application are not triggered by rerun actions."
        ),
    ).pack(side="left")
