...
def merge_questa_coverage(project: ProjectConfig) -> dict:
    ...
    multibit_expression_points = (
        [
            ...
            if point.get("type") == "expression" and point.get("multibit") is True
        ]
    ...
    multibit_expression_status = (
        "ok"
        if multibit_expression_report.returncode == 0 and multibit_expression_points
        else "empty"
        if multibit_expression_report.returncode == 0
        else "tool-error"
    )
    ...
    payload = {
        ...
        **metrics,
        ...
        "multibit_expression_returncode": int(multibit_expression_report.returncode),
