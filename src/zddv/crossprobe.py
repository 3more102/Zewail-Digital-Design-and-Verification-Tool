...
def _pin_binding_item_errors(
    ...
    *,
    ...
    if instance_module is not None and (
        ...
        errors.append(f"{prefix}.instance_module is not a non-empty string or null")

    generate_scopes = item.get("generate_scopes")
    if generate_scopes is not None and (
        not isinstance(generate_scopes, list)
        or any(
    ...
    if expression_type is not None and (
        ...
        errors.append(f"{prefix}.expression_type is not a non-empty string or null")
        ...
        if trusted_pin_contract:
            ...
            if not valid_unsupported_count:
                errors.append(
                    ...
                    "unsupported_expression_count is not a non-negative integer"
                )
