...
def cmd_coverage(args) -> int:
    ...
    if result.get("zero_details"):
        print(f"Zero-hit source detail: {result['zero_details']}")
    elif result.get("zero_details_capture") == "unavailable":
        print("Zero-hit source detail: unavailable")
