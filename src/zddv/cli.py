...
def cmd_coverage(args) -> int:
    ...
    xcelium_toggle_status = result.get("toggle_detail_status")
    if xcelium_toggle_status is not None:
        print(
            "Xcelium toggle detail: "
            f"{xcelium_toggle_status} "
    ...
    if simulator == "verilator":
        ...
        if not points:
            raise RuntimeError(
                ...
                f"{source_path}. ZDDV only normalizes the verified "
