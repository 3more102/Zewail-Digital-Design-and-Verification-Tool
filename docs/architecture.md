...
This is not a UCIe conformance checker. It does not encode proprietary/evaluation-copy
rules for PHY electrical behavior, training-state timing, retry sequencing, protocol
mappings, lane repair, or exact CRC construction.
