...
AXI data width, verifies that WSTRB has one bit per data byte, derives
`address_width_bits` and `data_width_bits`, and records the declared VCD widths for USER signals
