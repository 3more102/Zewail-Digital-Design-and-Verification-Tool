...
The source cross-probe remains conservative, while simulator-resolved hierarchy is
available separately through the elaboration index. Generated signal/connectivity
semantics still require richer simulator AST evidence before ZDDV should claim exact
elaborated drivers/loads.
