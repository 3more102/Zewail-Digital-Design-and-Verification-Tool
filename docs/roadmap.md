...
foundation. Core AXI4 exclusive-access semantics, address-sideband width/AxREGION 4KB
consistency, and observable USER-sideband preservation/stability checks are implemented;
exhaustive optional AXI4 sideband/coherency semantics, structural CDC signoff, and
