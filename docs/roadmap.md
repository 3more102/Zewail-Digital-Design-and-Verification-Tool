...
AXI4-Lite, with burst-aware AXI4 trace analysis and direct AXI4 VCD extraction now
implemented. Exhaustive AXI4 optional semantics, CDC-oriented checks, and UCIe transaction analysis remain planned.
...
- [x] AXI4 burst VCD extraction on configurable ACLK edges with timestamp preservation.
