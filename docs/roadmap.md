...
foundation. Core AXI4 exclusive-access semantics plus address-sideband width, reserved AxCACHE
encoding, and AxREGION 4KB consistency checks are also implemented; exhaustive optional AXI4 sideband/coherency
