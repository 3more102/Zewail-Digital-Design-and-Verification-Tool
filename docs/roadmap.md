...
coverage history, coverage merge, coverage-hole reporting, assertion result storage,
functional-coverage bin aggregation, and failure clustering are implemented.
