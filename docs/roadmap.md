...
- [x] Bounded SymbiYosys cover/reachability execution with explicit reached-goal evidence.
- [ ] Cross-run/aggregate formal coverage metrics beyond native cover reachability.
