...
functional-coverage database. Machine-readable XML plus complementary zero-hit source/file-line detail are retained when available; detailed code-coverage item/source normalization and holes remain planned.
