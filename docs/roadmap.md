...
explicit AXI ID_R_WIDTH/ID_W_WIDTH presence and range evidence, data-width-aware AxSIZE/WSTRB byte-lane
...
- [x] AXI4 ID_R_WIDTH/ID_W_WIDTH presence/range validation and paired VCD ID-width evidence.
