...
functional-coverage database. Detailed statement/branch source items are normalized into code coverage holes; condition/expression/toggle/FSM item adapters remain planned.
...
- [x] Questa detailed statement/branch item/source normalization and coverage-hole reporting.
- [ ] Questa condition/expression/toggle/FSM item-level coverage adapters.
