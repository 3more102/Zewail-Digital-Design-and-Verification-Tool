...
functional-coverage database, and a machine-readable XML coverage report is retained as
raw evidence; detailed code-coverage item/source normalization and holes remain planned.
