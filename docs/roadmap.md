...
normalized pin bindings plus source-edge validation against normalized elaborated evidence, assertion-to-waveform correlation, and the
...
- [x] Cross-probe validation of qualified source port edges against normalized elaborated direction and direct pin-binding evidence without relabeling source roles.
