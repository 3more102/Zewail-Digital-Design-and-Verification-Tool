...
- [x] Read-only waveform artifact navigation, VCD signal indexing, and bounded time-windowed targeted probing; FST remains metadata-only without a converter adapter.
