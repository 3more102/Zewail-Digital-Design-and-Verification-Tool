...
consistency checks, and optional USER-sideband transport evidence are implemented; exhaustive
optional AXI4 sideband/coherency semantics, structural CDC signoff, and specification-complete
