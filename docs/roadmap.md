...
cross-probing, assertion-to-waveform correlation, APB transaction reconstruction,
and APB VCD waveform-to-transaction extraction are implemented. Elaborated
connectivity remains planned.
