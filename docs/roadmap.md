...
foundation. Core AXI4 exclusive-access semantics, address-sideband width and AxREGION 4KB
consistency checks, reserved AxCACHE encoding validation and B/M/RA/WA attribute decoding,
and data-width-aware AxSIZE/WSTRB byte-lane validation are implemented; exhaustive optional
AXI4 sideband/coherency semantics, structural CDC signoff, and specification-complete UCIe
