...
functional-coverage database. Detailed statement and branch items from `vcover report -details -code sb`
are normalized into the shared code-hole model; condition/expression/toggle/FSM itemization remains planned.
