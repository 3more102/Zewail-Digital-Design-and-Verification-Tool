...
burst-aware AXI4, and a public-facts-based UCIe FLIT/link-health foundation. Exhaustive
AXI4 optional semantics, CDC-oriented checks, and specification-complete UCIe checking
remain planned.
