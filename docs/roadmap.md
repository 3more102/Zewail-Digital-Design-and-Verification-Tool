...
functional-coverage database. Detailed XML statement records are normalized into
source-linked code points for `coverage-holes`; additional detailed branch/condition/
expression/toggle schemas remain planned.
