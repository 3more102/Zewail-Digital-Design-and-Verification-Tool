...
- [x] Read-only recorded-VCD signal navigation and bounded in-memory targeted probe integration.
- [ ] Rendered waveform cursors and waveform-to-source cross-probe selection integration.
