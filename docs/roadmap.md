...
foundation. Core AXI4 exclusive-access semantics, address-sideband width/encoding checks,
AxREGION 4KB consistency, and USER-sideband capture/stall stability are implemented;
topology-dependent coherency, structural CDC signoff, and specification-complete UCIe
checking remain planned.
