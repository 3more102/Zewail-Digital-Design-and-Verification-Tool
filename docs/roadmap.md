...
simulator-resolved elaborated hierarchy, VCD waveform indexing, source-level
structural drivers/loads navigation, waveform-to-source cross-probing,
assertion-to-waveform correlation, and the first protocol transaction reconstruction
path (normalized APB traces) are implemented. Elaborated connectivity across
generated/parameter-specialized structures and waveform-driven protocol extraction
remain planned.
