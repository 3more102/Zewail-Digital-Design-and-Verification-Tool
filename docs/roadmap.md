...
AXI4-Lite, with a burst-aware AXI4 foundation now implemented. Exhaustive AXI4
optional semantics, CDC-oriented checks, and UCIe transaction analysis remain planned.
