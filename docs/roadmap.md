...
- [x] Read-only Desktop waveform surfacing for exact elaborated-to-source instance-port correlation, preserving source-structural role semantics and uncertainty states.
