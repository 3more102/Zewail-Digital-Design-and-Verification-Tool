...
project/action state, while generated verification artifacts use the existing isolated
staging and exact-content SHA-confirmed apply gate. No desktop action invokes AI or
executes generated code automatically.
