...
AXI4-Lite, with a burst-aware AXI4 foundation and an asynchronous-FIFO dynamic CDC
invariant checker now implemented. Exhaustive AXI4 optional semantics, structural CDC
signoff, and UCIe transaction analysis remain planned.
