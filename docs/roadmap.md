...
functional-coverage database. Documented by-instance XML statement records are normalized into source/line statement points for coverage-hole queries; branch/condition/expression/toggle/FSM item holes remain planned.
...
- [x] Questa XML statement/source normalization and statement-level coverage-hole reporting.
- [ ] Questa branch/condition/expression/toggle/FSM item-level normalization and hole reporting.
