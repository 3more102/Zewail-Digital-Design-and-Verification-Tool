...
preference and simulator-elaborated instance qualification plus explicit FST adapter
support, assertion-to-waveform correlation with explicit FST adapter support, and the
