...
AXI4-Lite, with burst-aware AXI4 reconstruction, direct VCD extraction, and core
exclusive-access semantics now implemented. Topology-dependent optional AXI4/ACE
semantics, CDC-oriented checks, and UCIe transaction analysis remain planned.
