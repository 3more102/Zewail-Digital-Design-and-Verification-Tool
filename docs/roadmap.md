...
functional-coverage database. Detailed code-coverage XML plus zero-hit source/file-line evidence
are retained as artifacts; parsing them into normalized code items/holes remains planned.
