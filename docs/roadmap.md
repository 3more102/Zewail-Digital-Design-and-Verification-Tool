...
- [x] Read-only recorded-VCD waveform navigation and bounded targeted probe integration.
- [ ] Rendered waveform cursors and waveform-to-source cross-probe selection.
