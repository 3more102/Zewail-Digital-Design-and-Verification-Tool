...
Current status: in progress. Source indexing and design hierarchy are implemented as
a simulator-independent debug index with JSON export and SQLite persistence.
