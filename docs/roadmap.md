...
- [x] Read-only source-unit and source-hierarchy navigation panes.
- [x] Persisted simulator-elaborated hierarchy browser when prior elaboration evidence exists.
