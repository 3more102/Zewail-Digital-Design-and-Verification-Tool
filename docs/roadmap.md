...
functional-coverage database. Detailed XML coverage evidence from `vcover report -xml`
is retained when available; code-coverage item/source normalization remains planned.
...
- [x] Questa detailed XML coverage evidence export and retention.
