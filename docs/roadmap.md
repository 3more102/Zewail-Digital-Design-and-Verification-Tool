...
- [x] Source-structural instance-port edges qualified against exact normalized elaborated child-pin bindings, with mismatches and unsupported expressions preserved as evidence.
