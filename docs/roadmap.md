...
consistency checks, reserved AxCACHE encoding validation/B/M/RA/WA attribute decoding, and observable USER-sideband preservation/stability checks are also implemented; exhaustive optional AXI4 sideband/coherency semantics, structural CDC signoff, and specification-complete UCIe checking remain planned.
...
- [x] AXI4 USER-sideband preservation and VALID/READY stability checking.
