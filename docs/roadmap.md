...
functional-coverage database. Machine-readable XML detail output and complementary zero-hit source/file-line evidence are retained when available. Statement/branch detail rows support by-file hole reporting, and documented by-instance XML statement records support instance-specific statement holes; condition/expression/toggle/FSM item normalization remains planned.
...
- [x] Questa statement/branch code-coverage hole reporting.
- [x] Questa by-instance XML statement-hole normalization.
