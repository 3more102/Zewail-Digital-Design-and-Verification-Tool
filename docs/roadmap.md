...
functional-coverage database. ZDDV also retains a documented detailed XML coverage
report when available; code item/source normalization from that evidence remains planned.
