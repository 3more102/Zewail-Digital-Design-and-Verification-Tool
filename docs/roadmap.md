...
- [x] Module-root Verilator ASSIGNW direct VARREF-to-VARREF internal driver/load evidence with fail-closed trusted-schema validation; complex assignment sides remain unresolved rather than inferred.
