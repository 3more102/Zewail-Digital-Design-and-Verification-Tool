...
item-level XML normalization/coverage-hole reporting and phase/objection lifecycle normalization are implemented, while sequence-aware UVM semantics remain planned.
