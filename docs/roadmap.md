...
functional-coverage database, and documented `vcover report -xml` output is retained as
raw machine-readable evidence; detailed code-coverage item/source normalization remains planned.
