...
item-level UCDB normalization/holes remain planned; phase/objection lifecycle trace normalization is implemented; sequence-aware UVM semantics remain planned.
