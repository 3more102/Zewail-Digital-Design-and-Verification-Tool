...
preference and simulator-elaborated instance qualification, explicit FST-backed
cross-probing/assertion correlation through `fst2vcd`, assertion-to-waveform
correlation, and the
...
- [x] Explicit opt-in FST waveform-to-source cross-probing and assertion correlation through `fst2vcd`, preserving source-artifact identity and converter provenance.
