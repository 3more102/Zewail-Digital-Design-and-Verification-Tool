...
- [x] Xcelium cumulative IMC Overall/Code/FSM/Functional Average/Covered normalization into percentage-native ZDDV coverage history.\n- [x] Xcelium explicit parenthesized covered/total count persistence without percentage-derived counts.\n- [ ] Xcelium item-level code/FSM/functional hole normalization.
