...
- [x] Read-only Desktop waveform surfacing of trusted elaborated/source instance-port correlation while preserving source-structural role semantics and uncertainty states.
