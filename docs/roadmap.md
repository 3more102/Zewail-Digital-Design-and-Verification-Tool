...
- [x] Automatic normalization of attached VCD counterexamples/witnesses during formal-result persistence, with explicit missing/ambiguous/unsupported evidence states.
