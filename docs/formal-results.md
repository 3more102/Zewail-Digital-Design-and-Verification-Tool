...
The normalized artifact layer does not parse vendor-native counterexample
waveforms, provide tool-specific formal result/trace ingestion, or claim formal
coverage. Those remain separate v0.7 milestones.
